            ...
            public void onClick(View view) {
              ...
              call.enqueue(new Callback<CordinatesList>() {
                  ...
                  public void onResponse(Call<CordinatesList> call, Response<CordinatesList> response) {
                      ...
                      if(response.isSuccessful()){
                          ...
                          try {
                              ...
                              Toast.makeText(SetOptions.this, "Entered city not found", Toast.LENGTH_SHORT).show();
                              dialog.dismiss();
                          }
                  ...
                  public void onFailure(Call<CordinatesList> call, Throwable t) {
                      Toast.makeText(SetOptions.this, "Server Error" + t, Toast.LENGTH_SHORT).show();
                  }
              });
            }
        });
            ...
            public void onResponse(@NonNull Call<PostList> call, @NonNull Response<PostList> response) {
                if(response.isSuccessful()){
                    ...
                    try {
                        ...
                        Toast.makeText(SetOptions.this, "It is not possible to determine your coordinates", Toast.LENGTH_SHORT).show();
                    }


                } else {
                    Toast.makeText(SetOptions.this, "Server Error", Toast.LENGTH_SHORT).show();
